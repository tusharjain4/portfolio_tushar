    ...
    <section id="contact" className="py-20 bg-gray-950">
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="flex flex-col items-center space-y-6">
          ...
          >
            <span className="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center border border-gray-700 group-hover:border-blue-500 transition-colors">
          ...
          <div className="flex space-x-6 mt-6">
            <a
              ...
              className="text-gray-400 hover:text-white transition-colors p-3 bg-gray-800 rounded-full border border-gray-700 hover:border-blue-500"
            >
